...
export default function Header() {
	...
	useEffect(() => {
		...
		// that checks if the window's inner width is greater than or equal to 960 pixels
		window.addEventListener(
			'resize',
			// Returns the inner width of the window (the width of the viewport)
	...
	return (
		<Navbar
			color='blue-gray'
			className='mx-auto mb-3 max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4 rounded-none shadow-xl shadow-blue-gray-900/50'
		>
